...
\end{figure}
Le modèle Camemebert a atteint une mesure F-0.5 maximale de x %TODO: remplacer x par mesure f0.5 maximale atteinte
après 100 époques.
...
d'entraînement intermédiaire. %TODO: insérer référence à Optuna
...
\message{ !name(rapport.tex) !offset(-959) }
