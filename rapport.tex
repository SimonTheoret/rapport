...
méthode MLM. %TODO: insérer citations à camembert et oscar.
...
\subsection{Recherche d'hyper-paramètres}
\subsection{Phase d'entraînement intermédiaire}
\chapter{Autre techniques} \label{chapitre:autretechnique}
\subsection{Soupe}
\subsection{Nettoyage des données}
\subsection{Fast-ELECTRA}
\subsection{Architecture hybrides à base de MOE}
\chapter{Conclusions}
