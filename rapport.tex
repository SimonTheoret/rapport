...
%TODO: Retirer soupe si pas les résultats ?
...
durant l'évaluation des modèles sur la tâche de ELECTRA:
...
\begin{tabular}{||c | c c c||}
 ...
 \hline\hline
    Exactitude du discriminant & 0.952 &  12 & 12 \\
    AUC du discrimiantn & 0.934 &  12 & 12 \\
    Perte du discriminant & 0.135 &  12 & 12 \\
    Précision du discriminant & 0.801 &  12 & 12 \\
    Rappel du discriminant & 0.469 &  12 & 12 \\
    Perte totale & 8.967 &  12 & 12 \\
    Exactitude du générateur & 0.570 &  12 & 12 \\
    Perte du générateur & 2.216 &  12 & 12 \\
    Exactitude du générateur & 0.469 &  12 & 12 \\
 \hline
\end{tabular}
\caption{Table to test captions and labels.}
\label{table:respreentrainement}
\end{table}

  % disc_accuracy = 0.9499838
  % disc_auc = 0.9295881
  % disc_loss = 0.14201258
  % disc_precision = 0.794754
  % disc_recall = 0.4497082
  % global_step = 2500000
  % loss = 9.411669
  % masked_lm_accuracy = 0.56244427
  % masked_lm_loss = 2.308568
  % sampled_masked_lm_accuracy = 0.45832235      

\section{Premiers modèles affinés}
Une fois les trois premiers modèles initaux préentraînés, nous avons entraîné
ces trois modèles sur la tâche de détection des erreurs en français.
Les meilleur métriques enregistrées sont détaillées dans le tableau \ref{table:premiermodeles}

Nous avons obtenu les mesures F-0.5 suivantes durant l'évaluation des trois premiers modèles:
...
\begin{tabular}{||c | c | c | c||}
 ...
 \hline
\end{tabular}
\caption{Résultats des modèles préliminaires sur corpus d'évaluation}
\label{table:premiermodeles}
\end{table}


\section{Entraînement modèle avec casse}
...
la case. Ce choix n'affecte que peu la performance du modèle durant le
préentraînement, mais pose problème durant l'affinage sur la tâche de détection
des erreurs.
...
%% S'il y a lieu, décommenter la ligne pour m ettre votre index
