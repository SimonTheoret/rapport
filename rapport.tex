...
la tâche. En l'occurence, nous avons sélectionner le jetoniseur Wordpiece \cite{wu2016googlesneuralmachinetranslation}.
...
l'affinage sont contenues dans la figure \ref{fig:3premiermodeles}. Nous utilisons la mesure F-0.5 comme principale métrique pour guider nos décisions. Un poids de 0.5 donne deux fois plus d'importance 

%% TODO: Ajouter les hyper-paramètres utilisés, les époques, etc.
...
%% TODO: retirer cette partie s'il n'y a pas de tableau.
%% TODO: insérer ref à tableau, si le tabeau existe.
...
%% TODO: Insérer résultats de tableau pour ELECTRA avec casse + sans casse pour affinage
...
%% TODO: remplacer x par mesure f0.5 maximale atteinte après 100 époques.
...
% TODO: Insérer tableau des résultats finaux
...
d'Optuna. La figure \ref{fig:electrapropre} montre les courbe de mesure F-0.5 durant la recherche
d'hyper-paramètre sur la tâche de détection des erreurs en français.
