...
%% Pour un mémoire
\documentclass[12pt,twoside,rapport]{dms}
%% Pour une thèse
...
\begin{table}
	%% TODO: Mettre à jour les hyperparamètres d'affinage avec les vraies valeurs (notamment taux d'apprentissage et Weight decay)
	\centering
	\begin{tabular}{||c | c ||}
		\hline
