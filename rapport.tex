...
méthode MLM. CAMEMBERT-base possède plus de 100 millions de paramètres, le
rendant près de 7 fois plus gros que nos modèle basés sur l'architecture de
...
mieux que nos modèles initaux et que le modèle sensible à la casse.
...
\begin{table}
	...
	\begin{tabular}{||c | c | c | c||}
		...
		Modèle initial 3  & 39.85    & 24.88  & 35.57 \\
		Modèle avec casse & 42.59    & 25.81  & 37.69 \\
		Camembert-base    & 44.74    & 29.3   & 40.47 \\
		\hline
	\end{tabular}
